    ...
    <nav class="fixed w-full z-50 top-0 start-0 border-b border-gray-200 bg-white/90 backdrop-blur-md shadow-sm">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <a href="<?php echo e(url('layanan')); ?>" class="hidden md:inline-flex text-white bg-primary hover:bg-primary-dark focus:ring-4 focus:outline-none focus:ring-emerald-300 font-semibold rounded-lg text-sm px-5 py-2.5 text-center shadow-lg shadow-emerald-500/30 transition-all duration-300 transform hover:scale-105">
                    Masuk ke Layanan
                </a>
        ...
        <div class="relative z-10 max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl fade-in-up">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="<?php echo e(url('layanan')); ?>" class="inline-flex justify-center items-center py-3 px-8 text-base font-semibold text-center text-white bg-primary rounded-lg hover:bg-primary-dark focus:ring-4 focus:ring-emerald-300 shadow-lg shadow-emerald-500/30 transition-transform transform hover:-translate-y-1">
                        Masuk ke Layanan
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-center">
                ...
                <div class="group relative rounded-3xl overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 p-8 md:p-10 transition-all hover:shadow-xl hover:shadow-blue-500/10">
                    ...
                    <div class="relative z-10">
                        ...
                        <a href="<?php echo e(url('layanan')); ?>" class="inline-flex items-center text-blue-600 font-semibold hover:text-blue-800 transition-colors">
                            Lihat Pengumuman
                ...
                <div class="group relative rounded-3xl overflow-hidden bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-100 p-8 md:p-10 transition-all hover:shadow-xl hover:shadow-emerald-500/10">
                    ...
                    <div class="relative z-10">
                        ...
                        <a href="<?php echo e(url('layanan')); ?>" class="inline-flex items-center text-primary font-semibold hover:text-primary-dark transition-colors">
                            Buat Laporan Baru
                            <svg class="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                        </a>
                    </div>
        ...
        <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-gray-100">
                <div class="p-4 py-8 md:py-4">
                    <div class="text-4xl md:text-5xl font-extrabold text-secondary mb-2"><?php echo e($stats['pengumuman_aktif'] ?? 0); ?></div>
                    <div class="text-slate-500 font-medium text-lg">Pengumuman Aktif</div>
                </div>
                <div class="p-4 py-8 md:py-4">
                    <div class="text-4xl md:text-5xl font-extrabold text-primary mb-2"><?php echo e($stats['laporan_bulan_ini'] ?? 0); ?></div>
                    <div class="text-slate-500 font-medium text-lg">Laporan Masuk Bulan Ini</div>
                </div>
                <div class="p-4 py-8 md:py-4">
                    <div class="text-4xl md:text-5xl font-extrabold text-emerald-500 mb-2"><?php echo e($stats['laporan_selesai'] ?? 0); ?></div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm mb-6">
                        <li><a href="<?php echo e(url('layanan')); ?>" class="hover:text-white transition-colors">Masuk ke Dashboard</a></li>
...
<?php /**PATH C:\xampp\htdocs\kawu\resources\views/welcome.blade.php ENDPATH**/ ?>