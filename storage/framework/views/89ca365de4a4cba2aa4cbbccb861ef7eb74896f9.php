...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> — SI-KAWU Admin</title>
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <nav class="flex-1 p-4 space-y-1">
            ...
            <a href="<?php echo e(route('admin.pengumuman.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('admin.pengumuman*') ? 'active' : ''); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="p-4 border-t border-slate-800">
            <div class="flex items-center gap-3 mb-3">
                ...
                <div class="flex-1 min-w-0">
                    <div class="text-white text-sm font-semibold truncate"><?php echo e(auth()->user()->name); ?></div>
                    <div class="text-slate-400 text-xs truncate"><?php echo e(auth()->user()->email); ?></div>
                </div>
            </div>
    ...
    <div class="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <header class="bg-white border-b border-slate-100 px-4 md:px-8 py-4 flex items-center justify-between shrink-0">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-lg md:text-xl font-bold text-slate-900"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h1>
                    <p class="hidden sm:block text-sm text-slate-500 mt-0.5"><?php echo $__env->yieldContent('page-subtitle', 'Selamat datang di panel admin SI-KAWU'); ?></p>
                </div>
            </div>
            <div class="flex items-center gap-3">
                <span class="hidden sm:block text-sm text-slate-500"><?php echo e(now()->isoFormat('dddd, D MMMM Y')); ?></span>
            </div>
        </header>
...
<?php /**PATH C:\xampp\htdocs\kawu\resources\views/admin/layout.blade.php ENDPATH**/ ?>