            ...
            <form action="<?php echo e(route('login.post')); ?>" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus
                           ...
                           class="w-full bg-white/5 border <?php echo e($errors->has('email') ? 'border-red-500/50' : 'border-white/10'); ?> text-white rounded-xl px-4 py-3 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mt-8 pt-6 border-t border-white/5 text-center">
                <a href="<?php echo e(route('home')); ?>" class="text-sm text-slate-500 hover:text-slate-300 transition-colors">
        ...
        <p class="text-center text-slate-600 text-xs mt-6">
            © <?php echo e(date('Y')); ?> SI-KAWU — Pemerintah Desa Kawu
        </p>
    </div>

</body>
</html>
<?php /**PATH C:\xampp\htdocs\kawu\resources\views/auth/login.blade.php ENDPATH**/ ?>